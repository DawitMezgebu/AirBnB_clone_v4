 ...
 */ (function () {
  ...
  var a = function (a, b) {
    ...
    h = function (a) {
      return (
        (a.indexOf("?") >= 0 ? "&" : "?") + "nocache=" + new Date().getTime()
      );
    },
    i = function (a) {
      var b = [];
      return (
        a.trustedDomains &&
          (typeof a.trustedDomains == "string"
            ? b.push("trustedDomain=" + a.trustedDomains)
            : b.push("trustedDomain=" + a.trustedDomains.join(","))),
        b.join("&")
      );
    },
    j = function (a, b) {
  ...
  (l.prototype.setCurrent = function (b) {
    ...
    (l.prototype.setText = function (a) {
      a &&
        a !== "" &&
        ((this.options.text = a), this.ready() && this.flashBridge.setText(a));
    }),
  ...
  var p = function () {
    ...
    if (!b) {
      var c =
        ...
        a.options.moviePath +
        h(a.options.moviePath) +
        '"/>         <param name="allowScriptAccess" value="' +
        a.options.allowScriptAccess +
    ...
    (a.htmlBridge = b),
      (a.flashBridge =
        document["global-zeroclipboard-flash-bridge"] ||
        b.children[0].lastElementChild);
  };
  (l.prototype.resetBridge = function () {
    ...
    (l.prototype.on = function (a, b) {
      ...
      this.handlers.noflash &&
        !l.detectFlashSupport() &&
    ...
    (l.prototype.receiveEvent = function (a, b) {
      ...
      switch (a) {
        case "load":
          if (
            b &&
            parseFloat(
              b.flashVersion.replace(",", ".").replace(/[^0-9\.]/gi, "")
            ) < 10
          ) {
      ...
      if (this.handlers[a]) {
        ...
        typeof j == "function"
          ? j.call(c, this, b)
          : typeof j == "string" && window[j].call(c, this, b);
      }
    }),
